...
def tsc_tutorial(attack_method='fgsm',batch_size=BATCH_SIZE,
    ...
    root_dir = '/home/maghvami/next/ijcnn19attacks'
    ...
    file_path = root_dir +'/'+ classifier_name + '/' + archive_name + \
                '/' + dataset_name + '/best_model.hdf5'
...
def main(argv=None,attack_method='fgsm'):
    ...
    # full datasets
    # dataset_znames = ['50words', 'Adiac', 'ArrowHead', 'Beef', 'BeetleFly', 'BirdChicken', 'Car', 'CBF',
